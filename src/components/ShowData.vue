<template lang="pug">
  v-container
    v-row.text-center
      ...
      v-col.mb-4
        h1.display-2.font-weight-bold.mb-3 Bienvenido to Vuetify
...
export default {
  ...
  created() {
    fetch("https://bio.torre.co/api/bios/josesanchez")
    ...
    httpAxios
      .get("https://bio.torre.co/api/bios/josesanchez")
      .then(response => {
    ...
    httpAxios
      .post(
        "https://search.torre.co/opportunities/_search/?offset=1&size=5&aggregate=2",
        null,
        config
      )
      .then(response => {
